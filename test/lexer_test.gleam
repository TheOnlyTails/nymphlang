...
pub fn decimal_int_test() {
  ...
  chomp_lexer.run_advanced("011", lexer.Normal(0), lexer.lexer())
  |> should.be_error()
...
pub fn radix_int_test() {
  ...
  chomp_lexer.run_advanced("0b10101001", lexer.Normal(0), lexer.lexer())
  |> should.be_ok()
  |> should.equal([
    Token(Span(1, 1, 1, 11), "0b10101001", token.BinaryInt(0b10101001)),
  ])
  // octal numbers are prefixed with 0o
  chomp_lexer.run_advanced("0o711413745", lexer.Normal(0), lexer.lexer())
  |> should.be_ok()
  |> should.equal([
    Token(Span(1, 1, 1, 12), "0o711413745", token.OctalInt(0o711413745)),
  ])
  // hexadecimal numbers are prefixed with 0x
  chomp_lexer.run_advanced("0xDEADF00D", lexer.Normal(0), lexer.lexer())
  |> should.be_ok()
  |> should.equal([
